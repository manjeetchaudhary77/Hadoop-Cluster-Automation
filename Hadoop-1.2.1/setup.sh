...
start(){
dialog --title "Hadoop Installation Process" --backtitle "BIG DATA HADOOP 1.2.1" --msgbox\
...
select_type()
{
	dialog --title "Hadoop Installation Process" --backtitle "BIG DATA HADOOP 1.2.1" \
	 --menu "What Type of Configuration Do You Want?" 0 0 2 \
	1 "Automatic(Recommended)"  \
	 2 "Manual(Advance)"  2>/tmp/menu.txt 	
}
